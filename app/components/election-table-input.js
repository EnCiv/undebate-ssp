...
function Table({ columns, data, updateMyData, skipPageReset, addRow }) {
    ...
    return (
        <>
            ...
            <div className='pagination'>
                ...
                <button type='button' onClick={() => previousPage()} disabled={!canPreviousPage} title='Previous page'>
                    {'<'}
                </button>{' '}
...
export default ElectionTableInput
